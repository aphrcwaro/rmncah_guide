...
This section explains how to structure and upload data into the app, ensuring compatibility with the app set-up
...
-   .xls, .xlsx (Excel files)- The raw health facility dataset using the **Countdown data extraction template**
...
Ensure your data is cleaned and structured according to the **The Countdown Health facility data (HFD) format** by:
