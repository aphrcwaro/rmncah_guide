...
|                                                                            |                                                                                       | Data A djustment                |                                                                                                 |           |
+----------------------------------------------------------------------------+---------------------------------------------------------------------------------------+---------------------------------+-------------------------------------------------------------------------------------------------+-----------+
| 2\. Denominator assessment and selection (target populations, live births) | Master facility adjusted data set (already loaded within the app)                     | De nominator selection          | Report 2: Denominator selection                                                                 |           |
|                                                                            |                                                                                       |                                 |                                                                                                 |           |
...
-   Check the internal consistency of the DHIS2 population growth over time. The population growth rates are computed \[e.g., pop(2024)-pop(2023)/pop(2023)\], as well as the crude birth rates (defined as the number of live births in DHIS2 projections per 1,000 population). We expect both rates to be consistent over time (e.g., less than 2 per 1,000 difference between years).

-   Compare the population data in DHIS2 with the UN population projections at the national level. Differences may occur, but large differences suggest that there is a problem with the DHIS2 population projections. This comparison is done for four indicators and abnormal values are flagged:

<!-- -->

-   Population size: a relative difference between the DHIS2 and UN \> projected population size greater than 5% should be considered a \> data quality issue with the DHIS2 population projections (relative \> difference = \|(pop(DHIS2) -- pop(UN))/ pop(UN)\|).

-   Population growth during 2023-2024: compute the annual population \> growth during 2023-2024 (formula: ln(pop2024/pop2023)). An \> absolute difference of the population growth rate greater than \> 0.3% population (\|growth DHIS2 -- growth UN\|) is a reason for \> concern with the data quality.

-   Crude birth rate (CBR): this is defined as the number of live births \> per 1,000 population. We compare the DHIS2 CBR (total projected \> live births / total population \* 1000) for 2023 with the UN \> estimate of the CBR for the same year. If the difference is \> greater than 5 per 1,000 population, the DHIS2 projection may be \> problematic.

-   Crude death rate (CDR**)**: this is defined as the number of deaths \> per 1,000 population. It is the difference between the crude birth \> rate and the population growth if there is no major out- or \> in-migration. We compute the CDR from the DHIS2 projections as \> CBR - population growth rate (both per 1,000) and compare it to \> the UN projection. If the DHIS2 shows a negative CDR or a CDR less \> than 5 per 1,000 population, the data are inconsistent.
...
+------------------------+-------------------------------------------------------------------------------------------------------------------+--------------------------------------------------------------+-----------------------------------------------------------------+
| hiv_test               | HIV test conducted among pregnant women (%)                                                                       | Not ava ilable (in some survey re ports)                     |                                                                 |
+------------------------+-------------------------------------------------------------------------------------------------------------------+--------------------------------------------------------------+-----------------------------------------------------------------+
