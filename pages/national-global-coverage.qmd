...
Here we calculate **Median Absolute Deviation from the Median (MADM)** to quantify spread in coverage in districts within an admin1 level , compared with the coverage at the said Admin1 sub-national unit.
